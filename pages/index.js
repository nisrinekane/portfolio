        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md text-center py-5 leading-8 text-gray-200 max-w-xl mx-auto md:text-xl">
              I am a software engineer based in Los Angeles. I am passionate about writing clean code to solve complex issues. My interests include FinTech, HealthTech and smart cities. I am currently working as a backend engineer.
            </p>
            ...
            <div class="flex flex-row rounded overflow-hidden shadow-lg">
              <div className="m-10 bg-custom-blue p-8">
                ...
                <div class="px-6 py-4">
                  ...
                  <p className="text-slate-500 mt-8">Technologies: Python, Pandas, Numpy, Scikit-Learn.</p>
                </div>
              </div>
              {/* budget buddy */}
              <div className="m-10 bg-custom-blue p-8">
                ...
                <div class="px-6 py-4">
                  ...
                  <p className="text-slate-500 mt-10">Technologies: React, Node.js, and Bootstrap.</p>
                </div>
              </div>
            </div>
